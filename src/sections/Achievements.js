    ...
    const badges = [
      {
        ...
        img: "https://hacktoberfest.digitalocean.com/_nuxt/img/logo-hf-icon.6b4a329.svg",
        title: "Hacktober fest 2021",
        bodyText:
          "I participated and successfully completed the required tasks at hacktoberfest.",
        link: "https://hacktoberfest.digitalocean.com/",
        buttonText: "Hacktoberfest 2021",
      },
      {
        alt: "Hacktoberfest 2020 badge",
        img: "https://tasnimzotder.github.io/hacktoberfest-2020/assets/docs_img/Icon.svg",
      ...
      },
      {
        ...
        bodyText:
          "I contributed code to 3 repositories in the 2020 GitHub Archive Program.",
                  ...
                  <div className="popover-container">
                    <div className="card">
                      <div className="card-header">
                        <div className="card-title h6">{badge.title}</div>
                      </div>
                      {badge.bodyText && (
                        <div className="card-body">{badge.bodyText}</div>
                      )}
                      {badge.buttonText && badge.link && (
